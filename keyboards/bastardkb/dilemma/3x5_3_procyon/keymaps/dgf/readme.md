# Dilemma v3 `dgf` keymap

The Dilemma `via` keymap is based on a [Colemak Mod-DH layout](https://colemakmods.github.io/mod-dh/) with [home row mods](https://precondition.github.io/home-row-mods) and [Miryoku flip inspired layers](https://github.com/manna-harbour/miryoku), and some features and changes specific to the Dilemma.
